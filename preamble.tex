...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[style=numeric,backend=biber,refsection=chapter]{biblatex} 	%kommentieren für use of BibTeX
...
% Zum Verwalten der Zitate benutze ich Zotero, zum Erzeugen der .bib-Datein für Latex wird die Exportfunktion von Zotero benutzt (rechtsklick auf ``Meine Bibliothek'' im linken Reiter: Option Biblatex in die Datei bib-zotero-export.bib aus welcher ich dann die betreffenden Zitate auf Richtigkeit \"uberpr\"ufe und in die bib.bib kopiere.
%
...
% Section Überschriften gestalten
